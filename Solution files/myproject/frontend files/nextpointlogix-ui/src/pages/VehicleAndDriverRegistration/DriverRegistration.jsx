...
const DriverRegistration = () => {
  ...
  const handleSave = async () => {
    const formattedData = {
      ...
      driving_experience: driverData.drivingExperience
        ? parseInt(driverData.drivingExperience, 10)
        : null,
      ...
      year_of_birth: driverData.yearOfBirth
        ? parseInt(driverData.yearOfBirth, 10)
        : null,
      ...
      <div className="template21-content">
        <div className="template21-left-column">
          <div className="driver-registration-buttons">
            ...
            <button onClick={handleSaveWithConfirmation}>
              {t("buttons.save")}
            </button>
          </div>
        </div>
        <div className="dr-template21-right-column">
          <form className="driver-registration-fields">
            ...
            <input
              name="yearOfBirth"
              type="number"
              placeholder={t("placeholders.year_of_birth")}
              onChange={handleInputChange}
            />
            ...
            <input
              name="citizenship"
              type="text"
              placeholder={t("placeholders.citizenship")}
              onChange={handleInputChange}
            />
            ...
            <input
              name="contractType"
              type="text"
              placeholder={t("placeholders.contract_type")}
              onChange={handleInputChange}
            />
            ...
            <input
              ...
              type="text"
              placeholder={t("placeholders.residence_address")}
              onChange={handleInputChange}
            />
            ...
            <input
              ...
              type="text"
              placeholder={t("placeholders.registration_address")}
              onChange={handleInputChange}
            />
            ...
            <input
              ...
              type="number"
              placeholder={t("placeholders.driving_experience")}
              onChange={handleInputChange}
            />
            ...
            <input
              ...
              type="text"
              placeholder={t("placeholders.license_category")}
              onChange={handleInputChange}
            />
            ...
            <input
              ...
              type="date"
              placeholder={t("placeholders.license_issue_date")}
              onChange={handleInputChange}
            />
            ...
            <input
              name="licenseIssuer"
              type="text"
              placeholder={t("placeholders.license_issuer")}
              onChange={handleInputChange}
            />
