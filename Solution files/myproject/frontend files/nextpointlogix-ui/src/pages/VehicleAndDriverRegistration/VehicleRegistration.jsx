      ...
      <div className="template21-content">
        <div className="template21-left-column">
          ...
          <div className="driver-registration-buttons">
            <button onClick={handleImagePreview}>
              {t("buttons.upload_picture")}
            </button>
            <button onClick={handleSubmit} disabled={isSaving}>
              {isSaving ? t("buttons.saving") : t("save")}
            </button>
          </div>
        </div>
        ...
        <div className="dr-template21-right-column">
          ...
          <form className="driver-registration-fields" onSubmit={handleSubmit}>
            ...
            <label htmlFor="license_plate_format">
              {t("license_plate_format")}
            </label>
            <select
              id="license_plate_format"
              name="license_plate_format"
              value={vehicleData.license_plate_format}
              onChange={handleChange}
            >
            ...
            <input
              ...
              name="engine_volume"
              step="0.1"
              placeholder={t("enter_engine_volume")}
            ...
            <input
              ...
              id="registered_to"
              name="registered_to"
              placeholder={t("enter_registered_to")}
            ...
            <label htmlFor="city_fuel_consumption">
              {t("city_fuel_consumption")}
            </label>
            <input
              type="number"
              ...
              step="0.1"
              placeholder={t("enter_city_fuel_consumption")}
              value={vehicleData.city_fuel_consumption}
              onChange={handleChange}
              required
            />

            <label htmlFor="highway_fuel_consumption">
              {t("highway_fuel_consumption")}
            </label>
            <input
              type="number"
              ...
              step="0.1"
              placeholder={t("enter_highway_fuel_consumption")}
